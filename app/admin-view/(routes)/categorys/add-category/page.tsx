...
export default function AddCategory() {
  ...
  const createCategroy = async (e: any) => {
    e.preventDefault();
    ...
    <>
      ...
      <div>
        <div className="flex items-center justify-between mx-5">
          <h3 className="flex  my-5 text-2xl font-semibold">Add category</h3>
        </div>
        <div>
          <form onSubmit={createCategroy}>
            <div className="flex mx-5 ">
              <div className=" mr-5 bg-white shadow-md p-4 h-fit">
                <label htmlFor="dir">Add Name</label>
                <Input
                  type="text"
